...
//        String result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(Collectors.joining("|")); // Ne fonctionne pas
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname))
        											   .collect(Collectors.toMap(Customer::getGender, Customer::getFirstname, 
        																		 (nomsExistant, nomSupplementaire) -> nomsExistant + "|" + nomSupplementaire)); 
        																		 // Permet de ne pas dupliquer la clé "F" ou "M"
